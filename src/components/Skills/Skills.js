      ...
      <Fade bottom>
        <div className="section--top">
          ...
          <div className="section--data">
            ...
            <p className="section--description">
              I have rich experience with front-end development tools which
              helps me to create a attractive web design layout.
            </p>
          ...
          <div className="section--data">
            ...
            <p className="section--description">
              Learning and creating server side languages (MERN stack) projects.
              I have exposure to node.js and python.
            </p>
